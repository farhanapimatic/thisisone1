...
public class RequestBuilder {
    ...
    public RequestBuilder cartCreateRequest(CartCreateRequest cartCreateRequest) {
        request.setCartCreateRequest(cartCreateRequest);
        return this;
    }

    public RequestBuilder cartModifyRequest(CartModifyRequest cartModifyRequest) {
